...
import { type Colors, Liquid } from './liquid-gradient';
...
export const LiquidGradientButton: React.FC<LiquidGradientButtonProps> = ({ className = '' }) => {
      ...
      >
        ...
        <div className="relative w-full h-full overflow-hidden rounded-lg">
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <span
              key={`spark-${i}`}
              className={`absolute inset-0 rounded-lg border-solid border-[3px] border-white/80 mix-blend-overlay filter ${
